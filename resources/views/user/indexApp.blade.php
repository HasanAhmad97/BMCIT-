...
@section('content')
@php
  $title = __('Mobile development and design');
@endphp
...
.portfolio .portfolio-wrap .portfolio-links a{
    ...
    <div class="container-fluid align-items-centerrow " style="{{ app() -> getLocale() === 'en' ? 'direction: ltr; text-align: left;' : 'direction: rtl; text-align: right;'}}">
      ...
      <h3 class="title text-center col-12">{{__('site.Mobile development and design')}}</h3>
      ...
      <div class="row mb-5 mr-4 text-right">
        ...
        <div class="col-11 col-md-5 align-items-center mb-3">
            <img src="/img/portfolio/portfolio-19.jpeg" class="w-100" alt="">
        </div>
            ...
            @foreach ($works as $work)
              <div class="col-lg-4 col-md-6 portfolio-item">
                  <div class="portfolio-wrap">
                    <img src="{{ asset('storage/' .$work->app->image ) }}" class="bd-placeholder-img card-img-top" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225px" style="border-radius: 2%">

                  <div class="portfolio-links">
                    <h4 class="name" style=" font-weight:bold; color:white">{{$work->name}}</h4>
                    <a href="{{$work->app->link}}" class="venobox"><i class="bx bx-window-open"></i></a>
                    <a href="{{ asset('storage/' .$work->app->image) }}" data-gall="portfolioGallery" class="venobox" title="{{$work->name}}"><i class="bx bx-plus"></i></a>
                    </div>
